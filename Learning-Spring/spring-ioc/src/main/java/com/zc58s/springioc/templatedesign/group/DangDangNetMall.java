...
public class DangDangNetMall  extends NetMall {
    public DangDangNetMall(String uId, String wPwd) {
        super(uId, wPwd);
    }

    @Override
    protected Boolean login(String uId, String uPwd) {
        System.out.println("模拟当当用户登录 uId：" + uId + "uPwd：" + uPwd);
        return true;
    }
    ...
    protected Map<String, String> reptile(String skuUrl) {
        ...
        System.out.println("当当商品爬虫解析：" + map.get("name") + " | " + map.get("price"));
        return map;
    }
    ...
    protected String createBase64(Map<String, String> goodsInfo) {
        ...
        System.out.println("模拟生成当当商品base64海报");
